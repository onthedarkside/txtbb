...
.admin{
     text-decoration: none;
     font-weight: bold;
     color: <?php echo $admincolor; ?>;
}

.moderator{
     text-decoration: none;
     font-weight: bold;
     color: <?php echo $modcolor; ?>;
}
...
.friend{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $friendcolor; ?>;
}

.group1{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group1color; ?>;
}

.group2{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group2color; ?>;
}

.group3{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group3color; ?>;
}

.group4{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group4color; ?>;
}

.group5{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group5color; ?>;
}

.group10{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group10color; ?>;
}

.group11{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group11color; ?>;
}

.group12{
     text-decoration: none;
     font-weight: normal;
     color: <?php echo $group12color; ?>;
}
