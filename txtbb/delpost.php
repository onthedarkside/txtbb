...
if ($type==2){
	echo '<meta http-equiv="Refresh" content="0; URL=post.php?cat='.$cat.'&fid='.$fid.'&pid='.$pid.'&page=1">';
}else{
	echo '<meta http-equiv="Refresh" content="0; URL=board.php?cat='.$cat.'&fid='.$fid.'&pid='.$pid.'&s=1">';
}
