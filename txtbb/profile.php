...
if ($permit=="1") {
	...
	echo "<tr><td class=\"label\" style=\"vertical-align:middle;text-align:center;\" rowspan=11>";
	echo "<p>&nbsp;</p>";
	/*if ($ave=="1") {
		if ($av=="webav") {
	...
	echo "<tr><td class=\"label\">XMPP (1):</td>
		<td class=\"content\">$xmpp1</td></tr>\n";
	...
	echo "<tr><td class=\"label\">XMPP (2):</td>
		<td class=\"content\">$xmpp2</td></tr>\n";
