...
$VCaptchaFill = "Answer the question to prove you're not a spambot";

$VAllowSearchEngines = "Allow search engines to index forum pages?";

/*
 * Anonymity settings
 * */
$VUserAnonymitySettings = "User Anonymity";
$VEnforceProxy = "Enforce proxy (Tor, weak proxies if allowed, VPN IP's on list)?";
$VAllowWeakProxies = "Allow weak proxies (proxy websites etc. - often worse than no proxy at all)?";
$VAllowIPListPathName = "List of allowed VPN IP adresses (can be manually edited to allow VPN IP adresses)";
$VAllowIPListPath = "./vpnallow/vpn_allow.txt";
$VRedirectToPage = "Redirect to the following page (full URL, such as http://mypage.com/badproxy.html) if non-allowed proxy settings are found";
...
$VMembers59="members";          //plural form - 2 forms needed for Russian language - hence also in other languages
//$VMember="member";
...
$VHidden="Hidden";
$Charset='iso-8859-1,iso-8859-15';
...
$VForumButtonColor="Forum title background color";
$VForumButtonOver="Forum title mouse over background color";
$VForumButtonTopics="Forum topics background color";
$VForumButtonReplies="Forum Replies background color";
$VForumButtonLast="Forum last post background color";
...
$VCurrentMembers1="There is currently";    //The variables $VCurrentMember and $VCurrentmembers can be removed!
...
$VExplainSlogan="A slogan is shown instead of an avatar picture. May be a short line or nothing.";
...
$OpenTopicread='An open topic - read';
...
//10 Feb 2005
$VNoViewPermission='You have no permission to view this thread';
//27 Feb 2005
$VTestMode='Test mode';
